...
// This file generates the RSS feed for the 'blog' collection
...
export async function GET(context: any): Promise<Response> {
  ...
  return rss({
    title: `${siteDefaults.siteName} | Blog`,
    description: `Latest blog updates from ${siteDefaults.siteName}`,
